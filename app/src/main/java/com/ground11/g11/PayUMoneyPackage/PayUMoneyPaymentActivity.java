...
public class PayUMoneyPaymentActivity extends AppCompatActivity implements View.OnClickListener,ResponseManager {
    ...
    private com.ground11.g11.PayUMoneyPackage.AppPreference mAppPreference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Up SharedPref
        setUpUserDetails();
        ((com.ground11.g11.PayUMoneyPackage.BaseApplication) getApplication()).setAppEnvironment(AppEnvironment.SANDBOX);
