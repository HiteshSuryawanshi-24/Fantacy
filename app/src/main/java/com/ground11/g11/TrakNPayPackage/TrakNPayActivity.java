...
public class TrakNPayActivity extends AppCompatActivity implements ResponseManager {
    ...
    public void initializePayment(){
        ...
        com.indian11.app.TrakNPayPackage.TrakConstant.PG_ORDER_ID=Integer.toString(n);
        PaymentParams pgPaymentParams = new PaymentParams();
        pgPaymentParams.setAPiKey(com.indian11.app.TrakNPayPackage.TrakConstant.PG_API_KEY);
        ...
        pgPaymentParams.setCurrency(com.indian11.app.TrakNPayPackage.TrakConstant.PG_CURRENCY);
        pgPaymentParams.setDescription(com.indian11.app.TrakNPayPackage.TrakConstant.PG_DESCRIPTION);
        pgPaymentParams.setCity(TCity);
        pgPaymentParams.setState(TState);
        pgPaymentParams.setAddressLine1(com.indian11.app.TrakNPayPackage.TrakConstant.PG_ADD_1);
        pgPaymentParams.setAddressLine2(com.indian11.app.TrakNPayPackage.TrakConstant.PG_ADD_2);
        pgPaymentParams.setZipCode(TZipCode);
        pgPaymentParams.setCountry(com.indian11.app.TrakNPayPackage.TrakConstant.PG_COUNTRY);
        pgPaymentParams.setReturnUrl(com.indian11.app.TrakNPayPackage.TrakConstant.PG_RETURN_URL);
        pgPaymentParams.setMode(com.indian11.app.TrakNPayPackage.TrakConstant.PG_MODE);
        pgPaymentParams.setUdf1(com.indian11.app.TrakNPayPackage.TrakConstant.PG_UDF1);
        pgPaymentParams.setUdf2(com.indian11.app.TrakNPayPackage.TrakConstant.PG_UDF2);
        pgPaymentParams.setUdf3(com.indian11.app.TrakNPayPackage.TrakConstant.PG_UDF3);
        pgPaymentParams.setUdf4(com.indian11.app.TrakNPayPackage.TrakConstant.PG_UDF4);
        pgPaymentParams.setUdf5(com.indian11.app.TrakNPayPackage.TrakConstant.PG_UDF5);
