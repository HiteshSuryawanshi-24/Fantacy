...
public abstract class VolleyApiCalling extends Activity implements VolleyRestClient {
    ...
    @Override
    public void callRestApi(String url, JSONObject jsonObject, Context mContext, Activity activity, String type, APIRequestManager serverResponseListner, boolean isShowProgress) {
    ...
    public void callRestApi(String url, final JSONObject jsonObject, final Context mContext,
        ...
        if (com.ground11.g11.APICallingPackage.Class.Validations.isNetworkAvailable(mContext)) {

            if (isShowProgress)
                com.ground11.g11.APICallingPackage.Class.Validations.showProgress(mContext);
            final StringRequest stringRequest = new StringRequest(Request.Method.POST,
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String result) {
                            ...
                            if (isShowProgress)
                                com.ground11.g11.APICallingPackage.Class.Validations.hideProgress();
    ...
    //public abstract void callGetRestApi(String url, Context mContext, Activity activity, String type, ServerResponseListner serverResponseListner, boolean isShowProgress);
