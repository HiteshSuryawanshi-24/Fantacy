...
public class MyFixtureContestDetailsActivity extends AppCompatActivity implements ResponseManager {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_ContestTeamsName.setText(com.indian11.app.MyTabFragment.MyJoinedFixtureContestListActivity.IntenTeamsName);
        tv_ContestTimer.setText(com.indian11.app.MyTabFragment.MyJoinedFixtureContestListActivity.IntentTime);
        ...
        Validations.CountDownTimer(com.indian11.app.MyTabFragment.MyJoinedFixtureContestListActivity.IntentTime,tv_ContestTimer);
    ...
    JSONObject createRequestJson() {
        ...
        try {
            jsonObject.put("contest_id", com.indian11.app.MyTabFragment.MyJoinedFixtureContestListActivity.ContestId);
    ...
    private void callLeaderboardTeam(boolean isShowLoader) {
        try {
            ...
            jsonObject.put("match_id", com.indian11.app.MyTabFragment.MyJoinedFixtureContestListActivity.Matchid);
       ...
       /* dialogGroundView = new BottomSheetDialog(activity);
        ...
        im_Editteam.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    ContestListActivity.IntentMatchId= com.indian11.app.MyTabFragment.MyJoinedFixtureContestListActivity.Matchid;
