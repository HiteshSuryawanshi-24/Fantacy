...
import com.ground11.g11.PaytmPackage.CheckSumServiceHelper;
...
public class PaytmActivity extends AppCompatActivity implements PaytmPaymentTransactionCallback,ResponseManager {
    ...
    private void generateCheckSum() {
        ...
        try {
            checkSum = checksumGeneration(orderID,
                    customerID, PayAmount, com.indian11.app.PaytmPackage.Constants.CALLBACK_URL);
    ...
    public String checksumGeneration(String orderId, String cust_id,
        ...
        paramMap.put("MID", com.indian11.app.PaytmPackage.Constants.M_ID);
        paramMap.put("ORDER_ID", orderID);
        paramMap.put("CHANNEL_ID", com.indian11.app.PaytmPackage.Constants.CHANNEL_ID);
        paramMap.put("CUST_ID", customerID);
        paramMap.put("TXN_AMOUNT", PayAmount);
        paramMap.put("WEBSITE", com.indian11.app.PaytmPackage.Constants.WEBSITE);
        paramMap.put("INDUSTRY_TYPE_ID", com.indian11.app.PaytmPackage.Constants.INDUSTRY_TYPE_ID);
        paramMap.put("CALLBACK_URL", com.indian11.app.PaytmPackage.Constants.CALLBACK_URL+orderID);
        String checkSum = "";
        try {
            checkSum = CheckSumServiceHelper.getCheckSumServiceHelper().genrateCheckSum(com.indian11.app.PaytmPackage.Constants.MerchantKEY, paramMap);
            paramMap.put("CHECKSUMHASH", checkSum);
            boolean is = CheckSumServiceHelper.getCheckSumServiceHelper().verifycheckSum(com.indian11.app.PaytmPackage.Constants.MerchantKEY, paramMap, checkSum);
